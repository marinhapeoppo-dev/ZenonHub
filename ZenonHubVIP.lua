...
local function ShowTab(tabName)
    ...
    elseif tabName == "Teleport" then
        ...
        local islands = {
            ...
            {"Secret Area", CFrame.new(100, 20, 0)},
            {"Deep Water", CFrame.new(0, 5, 100)}
        }
        
        for i, island in ipairs(islands) do
            local islandBtn = Instance.new("TextButton", contentFrame)
            islandBtn.Size = UDim2.new(1, 0, 0, 40)
            islandBtn.Position = UDim2.new(0, 0, 0, (i-1)*45)
    ...
    elseif tabName == "Info" then
        ...
        version.Text = "Version: Premium 2.0"
...
Notif("MartinSC Premium Ready - Drag to move")
